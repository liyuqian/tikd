...
\draw[important line, sincolor]  (0.8660254037844387, 0.49999999999999994) -- node[left=1.0pt, fill=white] {$\sin \alpha$} ({(0.8660254037844387, 0.49999999999999994)} |- {x axis});
